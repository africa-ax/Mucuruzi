// ============================================================
//  MUCURUZI — DistributorDash.js
// ============================================================

const DistributorDash = (() => {
  ...
  const render = async (user, root) => {
    root.innerHTML = `
      <div class="page-header">
        ...
        <p class="page-subtitle">Your distribution overview</p>
      </div>
      ...
      <div class="dash-grid mt-lg">
        ...
        <div class="card">
          ...
          <div class="dash-actions">
            <button class="btn btn-primary btn-block mb-md" onclick="Router.navigate('#marketplace')">⊞ Browse Marketplace</button>
            <button class="btn btn-secondary btn-block mb-md" onclick="Router.navigate('#inventory')">⬡ View Inventory</button>
            <button class="btn btn-secondary btn-block" onclick="Router.navigate('#orders')">◫ My Orders</button>
          </div>
        </div>
      </div>
    `;
  ...
  const _loadStats = async (user) => {
    ...
    document.getElementById('dash-stats').innerHTML = `
      ${_statCard('Inventory Items', stock.length, 'In stock now', 'var(--color-distributor)')}
      ${_statCard('Pending Orders', pending, 'Right now', 'var(--color-warning)')}
      ${_statCard('Confirmed This Week', confirmedWeek, 'This week', 'var(--color-success)')}
